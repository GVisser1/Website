...
const SelectTrigger = forwardRef<ComponentRef<typeof Radix.Trigger>, Radix.SelectTriggerProps>(
  ({ className, children, ...props }, ref) => (
    <Radix.Trigger
      ref={ref}
      className={clsx(
        "flex h-10 w-full items-center justify-between gap-x-2 rounded-sm border border-primary bg-default px-3 py-2 text-button text-primary focus-visible:focus-ring dark:border-primary-dark dark:bg-default-dark dark:text-primary-dark",
        className,
      )}
      {...props}
    >
