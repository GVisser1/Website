      ...
      <TooltipRoot delayDuration={DELAY} disableHoverableContent>
        ...
        <TooltipPortal container={container}>
          <TooltipContent
            ...
            collisionPadding={8}
            className={clsx(
              "z-50 max-w-56 select-none overflow-hidden rounded-md bg-zinc-800 px-3 py-1.5 text-xs text-white animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2"
            )}
          >
