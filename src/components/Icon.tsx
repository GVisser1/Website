...
const LastFmIcon = ({ className = "" }) => (
  <svg id="Layer_1" version="1.1" className={className} viewBox="0 0 512 512">
    <defs id="defs19" />
    <g id="g3021" />
    <g id="Layer_1_1_" />
...
const SpotifyIcon = ({ className = "" }) => (
  <svg version="1.1" className={className} viewBox="0 0 24 24">
    <g fill="#10BD4C">
...
const LetterboxdIcon = ({ className = "" }) => (
  <svg className={className} viewBox="0 0 500 500" version="1.1">
