      ...
      {({ selectedOption }) => {
        ...
        return (
          ...
          >
            ...
            <span className={clsx(className, sharedClasses, "pointer-events-none col-start-2")}>{children}</span>
          </div>
        );
      }}
...
export const ListboxLabel = ({ className, ...props }: ComponentPropsWithoutRef<"span">): JSX.Element => (
