...
const HomePage = (): JSX.Element => (
  <Page>
    <div className="flex h-172 flex-col-reverse items-center justify-center gap-x-20 gap-y-8 lg:my-auto lg:h-180 lg:flex-row">
      <header className="flex flex-col gap-y-6 text-center lg:gap-y-6 lg:text-left">
        <h1 className="text-header-4xl font-bold text-primary lg:text-header-5xl dark:text-primary-dark">
